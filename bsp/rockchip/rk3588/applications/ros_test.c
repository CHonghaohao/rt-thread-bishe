...
#define RCSOFTCHECK(fn)                                                                                                     \
    {                                                                                                                       \
        rcl_ret_t temp_rc = fn;                                                                                             \
        if ((temp_rc != RCL_RET_OK)) { rt_kprintf("Failed status on line %d: %d. Continuing.\n", __LINE__, (int)temp_rc); } \
    }
...
{
    // rt_kprintf("ping_timer_callback\n");
